...
let tl7 = gsap.timeline({
    scrollTrigger: {
        trigger: ".part-7",
        start: "50% 50%",
        end: "300% 50%", // You can keep the original scroll length
        pin: true,
        scrub: 1, // Original scrub value
    },  
});

tl7.to("#demo", {
    bottom: "7%",
    duration: 3, // Keep the original speed for non-image elements
});

tl7.to(".our-work-txt-div", {
    height: "60vh",
    duration: 3, // Keep original speed
}, 'height');
